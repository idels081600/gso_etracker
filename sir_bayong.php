        ...
        <div class="main-content">
            <div class="container-fluid">
                ...
                <div class="form-container p-3">
                    <form action="add_data_bayong.php" method="POST" class="row g-10">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-select" id="supplierDropdown" name="supplier">
                                ...
                                <?php
                                $supplier_query = "SELECT DISTINCT Supplier FROM sir_bayong WHERE Supplier IS NOT NULL";
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-select" id="paymentDropdown" name="payment">
                                ...
                                <?php
                                $po_query = "SELECT po, amount FROM sir_bayong_payments ORDER BY id DESC";
...
a
        ...
        <script src="sir_bayong.js"></script>
