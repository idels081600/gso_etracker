...
$html .= '<tr>
            <td colspan="10" style="font-weight: bold;">Payment Details</td>
          </tr>';
...
$finalTotalAmount = $totalAmount - array_sum($poAmounts);
...
$html .= '<tr>
            <td colspan="10" style="text-align: right; font-weight: bold;">Total Payments:</td>
            <td style="font-weight: bold;">₱' . number_format(array_sum($poAmounts), 2) . '</td>
          </tr>';

$html .= '<tr>
            <td colspan="10" style="text-align: right; font-weight: bold;">Final Total Amount:</td>
