...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    ...
    if ($action === 'add_vehicle') {
        ...
        if (!in_array($status, ['Active', 'Under Repair', 'Out of Service'], true)) {
            $status = 'Active';
        }
    ...
    if ($action === 'add_repair') {
        ...
        $types = isset($_POST['repair_type']) && is_array($_POST['repair_type']) ? implode(', ', array_map('trim', $_POST['repair_type'])) : '';
