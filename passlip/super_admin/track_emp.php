...
if (isset($_POST['delete_all'])) {
  if ($_POST['confirm'] == 'yes') {
    // Backup current data
    $backup_sql = "CREATE TABLE IF NOT EXISTS temp_backup SELECT * FROM request";
...
if (isset($_POST['undo_delete'])) {
  $restore_sql = "INSERT INTO request SELECT * FROM temp_backup";
  mysqli_query($conn, $restore_sql);
  mysqli_query($conn, "DROP TABLE temp_backup");
