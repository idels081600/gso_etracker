...
if (isset($_POST['delete_all'])) {
  if ($_POST['confirm'] == 'yes') {
    ...
    $backup_sql = "INSERT INTO request_backup SELECT * FROM request WHERE DATE(date) = CURDATE() AND (Role = 'Employee' OR Role = 'TCWS Employee')";
    mysqli_query($conn, $backup_sql);

    $sql = "DELETE FROM request WHERE Role = 'Employee' OR Role = 'TCWS Employee'";
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="d-flex flex-column">
            <a href="../admin_approver/export_r.php?range=today" class="btn btn-primary mb-2">Export Current Date Data</a>
            <a href="../admin_approver/export_r.php?range=first15" class="btn btn-primary mb-2">Export 1st 15 Days of Current Month</a>
            <a href="../admin_approver/export_r.php?range=second15" class="btn btn-primary">Export 2nd 15 Days of Current Month</a>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
