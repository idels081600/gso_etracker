...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="dropdown">
                <a href="#"><i class="fas fa-map icon-size"></i> Inventory <i class="fas fa-chevron-down dropdown-icon"></i></a>
                <ul class="dropdown-menu">
                    <li><a href="pay_track.php">Payables</a></li>
                    <li><a href="rfq_tracking.php">RFQ</a></li>
                </ul>
            </li>
            <li><a href="tracking.php"><i class="fas fa-campground icon-size"></i> Inventory</a></li>
