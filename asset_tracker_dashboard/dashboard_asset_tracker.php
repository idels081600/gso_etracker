...
require_once __DIR__ . '/display_data_asset.php';
$result = display_data_dashboard();
$transpo = display_data_transpo();
$metrics = get_dashboard_metrics();
$on_stock = $metrics['tent_available'];
$total_rows = $metrics['tent_total'];
$on_stock_percent = $metrics['tent_available_percent'];
$on_field = $metrics['tent_installed'];
$on_retrieval = $metrics['tent_for_retrieval'];
$longterm = $metrics['tent_long_term'];
$ongarage = $metrics['vehicle_available'];
$departed = $metrics['vehicle_departed'];
$departed_Status = $metrics['vehicle_departed_percent'];
$on_stock_minus_20 = $on_stock -  $longterm;
$vehicle = $metrics['vehicle_available_percent'];
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="container1">
                ...
                <div class="asset-progress asset-progress--tent" role="progressbar" aria-label="Available tents" aria-valuenow="<?php echo e($on_stock_percent); ?>" aria-valuemin="0" aria-valuemax="100" style="--value:<?php echo e($on_stock_percent); ?> "></div>
            </div>
            ...
            <div class="container3">
                ...
                <div class="asset-progress asset-progress--vehicle" role="progressbar" aria-label="Available vehicles" aria-valuenow="<?php echo e($vehicle); ?>" aria-valuemin="0" aria-valuemax="100" style="--value: <?php echo e($vehicle); ?> "></div>
                <!-- Content for container 2 -->
            </div>
        ...
        <div class="container_table">
            <div class="column">
                ...
                <div class="search-container">
                    <label class="asset-sr-only" for="search-input">Search dashboard records</label>
                    ...
                    <table id="table_tent1" class="table_tent1" style="display: table;">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    <td class="tent-no-column"><?php echo e($row["tent_no"]); ?></td>
                                    <td><?php echo e($row["date"]); ?></td>
                                    <td><?php echo e($row["name"]); ?></td>
                                    <td><?php echo e($row["Contact_no"]); ?></td>
                                    <td><?php echo e($row["no_of_tents"]); ?></td>
                                    ...
                                    ?>
                                    <td class="status-cell <?php echo e($status_class); ?>"><?php echo e($row["status"]); ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($transpo)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo e($row["Date"]); ?></td>
                                    <td><?php echo e($row["Vehicle"]); ?></td>
                                    <td><?php echo e($row["Driver"]); ?></td>
                                    <td><?php echo e($row["Purpose"]); ?></td>
                                    <td><?php echo e($row["Location"]); ?></td>
                                    <td><?php echo e($row["Departure"]); ?></td>
                                    <td><?php echo e($row["Arrival"]); ?></td>
                                    <?php
                                    // Determine the class based on the status value
                                    $status_class = '';
                                    switch ($row["Status1"]) {
                                    ...
                                    ?>
                                    <td class="status-cell <?php echo e($status_class); ?>"><?php echo e($row["Status1"]); ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
                    ...
                    <table id="table_rfq" class="table_rfq" style="display: none;">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($rfq)) { ?>
                                <tr>
                                    <td><?php echo e($row["rfq_no"]); ?></td>
                                    <td><?php echo e($row["pr_no"]); ?></td>
                                    <td><?php echo e($row["rfq_name"]); ?></td>
                                    <td><?php echo e($row["date"]); ?></td>
                                    <td><?php echo e($row["amount"]); ?></td>
                                    <td><?php echo e($row["requestor"]); ?></td>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", () => {
                    ...
                    const hoverDataGarage = <?php echo json_encode(json_decode($hover_data_ongarage, true), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
                    const hoverDataField = <?php echo json_encode(json_decode($hover_data_onfield, true), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
                    ...
                    const showPopup = (hoverData, rect) => {
                        ...
                        const plateHeader = document.createElement('span');
                        plateHeader.className = 'vehicle-plate';
                        plateHeader.textContent = 'Plate Number';
                        const nameHeader = document.createElement('span');
                        nameHeader.className = 'vehicle-name';
                        nameHeader.textContent = 'Vehicle';
                        header.append(plateHeader, nameHeader);
                        ...
                        hoverData.forEach(vehicle => {
                            ...
                            plate.textContent = vehicle.Plate_No || '';
                            const name = document.createElement('span');
                            name.className = 'vehicle-name';
                            name.textContent = vehicle.Name || '';
                            div.append(plate, name);
