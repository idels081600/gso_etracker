...
<body>
            ...
            <div class="container_table_content">
                <div class="d-flex justify-content-between align-items-center mb-3 px-3" style="padding-left:0;padding-right:0;">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <button class="btn btn-warning" id="editStatusButton" role="button" data-bs-toggle="modal" data-bs-target="#editStatusModal"><i class="fas fa-edit"></i> Edit Status</button>
    ...
    <script>
        ...
        function updateTentStatus(tentId, newStatus, button) {
            ...
            $.ajax({
                url: 'update_bulk_tent_status.php', // Need to create this
                type: 'POST',
                data: {
                    tent_ids: [tentId],
